...
foreach([
	...
	$StatusJSONFile = "{$Environment->ScriptPath()}cron/process/{$Cron}/status.json";
	...
	$CronHTML[] = "
		<h2 id=\"Cron_{$CronIndex}\">
			...
			<span class=\"Action\">
				...
				<a href=\"{$Application->URL("Cron/{$Cron}", "Execute")}\" target=\"_blank\" class=\"Item\"><img src=\"{$Environment->IconURL()}execute.png\" alt=\"Execute\" title=\"Execute\" class=\"Icon\">Execute</a>
				<a href=\"{$Application->URL("Cron/{$Cron}", "SetResume")}\" target=\"_blank\" class=\"Item\"><img src=\"{$Environment->IconURL()}start.png\" alt=\"Start\" title=\"Start\" class=\"Icon\">Start</a>
				<a href=\"{$Application->URL("Cron/{$Cron}", "SetExit")}\" target=\"_blank\" class=\"Item\"><img src=\"{$Environment->IconURL()}stop.png\" alt=\"Stop\" title=\"Stop\" class=\"Icon\">Stop</a>
			</span>
		</h2>

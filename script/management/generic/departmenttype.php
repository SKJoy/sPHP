...
$ListColumn = [ // Columns to display
	...
	new HTML\UI\Datagrid\Column("{$Entity}" . ($Caption = "Identifier") . "", "{$Caption}", null, ALIGN_CENTER),
...
$InputDefaultValueFromSearchFieldList = "xEnterpriseID, xSomethingElseID";
...
$InputInterface = "
	...
	" . HTML\UI\Field(HTML\UI\Input("{$Entity}" . ($Caption = "Identifier") . "", $Configuration["InputInlineWidth"], null, null), "{$Caption}", null, true, $Configuration["FieldCaptionInlineWidth"]) . "

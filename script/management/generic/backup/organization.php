...
$ListAction = [ // Action
	new HTML\UI\Datagrid\Action("{$Environment->IconURL()}department.png", null, $Application->URL("Management/Generic/Department")),
...
$InputDefaultValueFromSearchFieldList = "EnterpriseID, xSomethingElseID";
...
$InputInterface = "
	...
	" . HTML\UI\Field(HTML\UI\Input("{$Entity}" . ($Caption = "Short") . "Name", $Configuration["InputInlineWidth"], null, null), "{$Caption} name", null, true, $Configuration["FieldCaptionInlineWidth"]) . "

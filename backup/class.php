...
class Session{
    ...
    #region Method
    public function __construct($Environment = null, $Guest = null, $Lifetime = null, $Isolate = null, $User = null, $Name = null, $ContentEditMode = null, $DebugMode = null, $IgnoreActivity = null, $Language = null){ //var_dump(__CLASS__ . "->" . __FUNCTION__); //exit;
		// Check if already instantiated and throw error if tried again
		if($this::$AlreadyInstantiated)trigger_error("Instantiation is prohibited for " . __CLASS__ .  " object.");
        $this::$AlreadyInstantiated = true;
    ...
    public function Start(){ //var_dump(__CLASS__ . "->" . __FUNCTION__); //exit;
	...
	public function Reset(){ //var_dump(__CLASS__ . "->" . __FUNCTION__); //exit;
		$Result = true;
    ...
    #region Property
    public function Environment($Value = null){ //var_dump(__CLASS__ . "->" . __FUNCTION__); //exit;
        if(is_null($Value)){
            $Result = $this->Property[__FUNCTION__];
        }
        else{
    ...
    public function Guest($Value = null){ //var_dump(__CLASS__ . "->" . __FUNCTION__); //exit;
        if(is_null($Value)){
            $Result = $this->Property[__FUNCTION__];
        }
        else{
    ...
    public function Lifetime($Value = null){ //var_dump(__CLASS__ . "->" . __FUNCTION__); //exit;
        if(is_null($Value)){
            $Result = $this->Property[__FUNCTION__];
        }
        else{
    ...
    public function Isolate($Value = null){ //var_dump(__CLASS__ . "->" . __FUNCTION__); //exit;
        if(is_null($Value)){
            $Result = $this->Property[__FUNCTION__];
        }
        else{
    ...
    public function User($Value = null){ //var_dump(__CLASS__ . "->" . __FUNCTION__, $Value); //exit;
        if(is_null($Value)){
            $Result = isset($_SESSION[__FUNCTION__]) ? $_SESSION[__FUNCTION__] : null;
        }
        else{
            ...
            global $sPHP;
            $sPHP["User"] = \sPHP::$User = $_SESSION[__FUNCTION__]; //var_dump(__CLASS__ . "->" . __FUNCTION__, $Value, $sPHP["User"], \sPHP::$User); //exit;
    ...
    public function Name($Value = null){ //var_dump(__CLASS__ . "->" . __FUNCTION__); //exit;
        if(is_null($Value)){
            $Result = $this->Property[__FUNCTION__];
        }
        else{
